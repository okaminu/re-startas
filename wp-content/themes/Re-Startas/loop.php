...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
	<?php //Rodo atskira bloka paieskai ir atskira kitiem straipsniam?>
			<?php if ( is_archive() || is_search() ) : // Only display excerpts for archives and search. ?>
			 <div class="SearchForma">
			<p class="SearchAntraste"><?php the_title();?></p>
			<div class="SearchTekstas"><?php the_excerpt();?></div>
			
			<a class="Search_linkasPAT" href="?p=<?php the_ID();?>">
		    Skaityti daugiau</a>
		    </div>
	<?php else : //nuo cia eina visi straipsniai kitam atvaizdavimui?>	
	...
	<?php endif; //SEARCH AND ARCHIVE END;?>
